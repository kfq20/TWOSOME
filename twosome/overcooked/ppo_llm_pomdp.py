...
def parse_args():
    ...
    parser.add_argument("--exp-name", type=str, default="tomato_salad_llm",
    ...
    parser.add_argument('--env-reward',             action='store',        type=float, nargs=4,  default=[0.2, 1, 0.1, 0.001],    help='The reward list of the env')
